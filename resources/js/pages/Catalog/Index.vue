...
const props = defineProps({
    products: Array,
    // 1. Terima prop promoBanners dari middleware
    promoBanners: Array 
});
...
<template>
    ...
    <div class="bg-rose-50 min-h-screen">
        <div class="max-w-7xl mx-auto py-12 sm:px-6 lg:px-8">
            ...
            <div v-if="promoBanners && promoBanners.length > 0" class="mb-12">
            ...
            <div v-else class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
                ...
                >
                    ...
                    <div class="p-5 text-center">
                        <span v-if="product.category" class="text-xs text-rose-600 uppercase font-semibold tracking-wider">
