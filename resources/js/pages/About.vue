...
<template>
    ...
    <!-- Hero Section -->
    <section class="relative bg-gradient-to-br from-rose-50 to-pink-100 py-20 overflow-hidden">
        <div class="absolute inset-0 bg-white/20"></div>
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div class="animate-on-scroll">
                    <h1 class="text-5xl lg:text-6xl font-light text-gray-900 mb-6 leading-tight">
                        Beauty Through<br>
                    ...
                    <div class="flex flex-wrap gap-4">
                        <button class="bg-rose-600 text-white px-8 py-3 rounded-full font-medium hover:bg-rose-700 transition-all duration-300 transform hover:scale-105 shadow-lg">
                            Discover Our Story
                        </button>
                        <button class="border border-rose-600 text-rose-600 px-8 py-3 rounded-full font-medium hover:bg-rose-600 hover:text-white transition-all duration-300">
                            Meet Our Team
                        </button>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="space-y-4">
                            ...
                            <img 
                                ...
                                alt="Product Testing"
                                class="rounded-2xl shadow-lg w-full h-32 object-cover"
                            />
                        </div>
    ...
    <section class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="animate-on-scroll group p-8 rounded-2xl bg-gradient-to-br from-rose-50 to-pink-50 hover:from-rose-100 hover:to-pink-100 transition-all duration-300 cursor-pointer">
    ...
    <!-- CTA Section -->
    <section class="py-20 bg-gradient-to-r from-rose-600 to-pink-600 text-white">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div class="animate-on-scroll">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <button class="bg-white text-rose-600 px-8 py-4 rounded-full font-semibold hover:bg-rose-50 transition-all duration-300 transform hover:scale-105 shadow-lg">
                        Shop Our Collection
                    </button>
                    <button class="border border-white text-white px-8 py-4 rounded-full font-semibold hover:bg-white hover:text-rose-600 transition-all duration-300">
