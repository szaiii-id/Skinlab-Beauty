...
// Ambil data user untuk pengecekan role (jika nanti dibutuhkan untuk hide/show menu)
const user = usePage().props.auth.user;

// Helper untuk mengecek active route agar styling menu dinamis
// Menggunakan try-catch agar tidak error saat route belum didefinisikan di web.php
...
<template>
    <aside class="w-72 bg-white border-r border-gray-100 hidden md:flex flex-col h-screen sticky top-0 shadow-[4px_0_24px_rgba(0,0,0,0.02)] z-30 font-sans">
        ...
        <nav class="flex-1 overflow-y-auto py-6 px-4 space-y-8 scrollbar-thin scrollbar-thumb-pink-100 scrollbar-track-transparent hover:scrollbar-thumb-pink-200">
                ...
                <div class="space-y-1">
                    ...
                    <Link 
                        ...
                        :class="isActive('admin.categories.index') 
                            ...
                            : 'text-gray-600 hover:bg-pink-50 hover:text-pink-700'"
                    >
                        <svg class="w-5 h-5 mr-3 transition-colors" :class="isActive('admin.categories.index') ? 'text-white' : 'text-gray-400 group-hover:text-pink-600'" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"></path></svg>
                        Categories
                    </Link>
                    ...
                    <Link 
                        ...
                        class="flex items-center px-4 py-2.5 text-sm font-medium rounded-xl transition-all duration-200 group relative overflow-hidden"
                        :class="isActive('admin.brands.index') 
                            ? 'bg-gradient-to-r from-pink-500 to-rose-600 text-white shadow-lg shadow-pink-200' 
                            : 'text-gray-600 hover:bg-pink-50 hover:text-pink-700'"
                    >
                        <!-- Icon tetap sama -->
                        <svg class="w-5 h-5 mr-3 transition-colors" :class="isActive('admin.brands.index') ? 'text-white' : 'text-gray-400 group-hover:text-pink-600'" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.384-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z"></path></svg>
                        Brands
                    </Link>
                    ...
                    <Link 
                        ...
                        :class="isActive('admin.products.index') 
                            ...
                            : 'text-gray-600 hover:bg-pink-50 hover:text-pink-700'"
                    >
                        <svg class="w-5 h-5 mr-3 transition-colors" :class="isActive('admin.products.index') ? 'text-white' : 'text-gray-400 group-hover:text-pink-600'" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"></path></svg>
                        All Products
                    </Link>
            ...
            <div>
                ...
                <div class="space-y-1">
                    ...
                    <a href="#" class="flex items-center px-4 py-2.5 text-sm font-medium rounded-xl text-gray-600 hover:bg-pink-50 hover:text-pink-700 transition-all duration-200 group">
                        <svg class="w-5 h-5 mr-3 text-gray-400 group-hover:text-pink-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>
                        Customers
                    </a>
                </div>
            </div>
