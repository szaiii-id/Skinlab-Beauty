...
class AddressController extends Controller
{
    ...
    {
        try {
            Log::info('Store address request:', $request->all()); // DEBUG

            // PERBAIKAN: Validasi yang lebih sederhana dulu
            ...
            // Pastikan is_default ada
            $data['is_default'] = $data['is_default'] ?? false;
            $data['is_active'] = true; // Tambahkan ini

            Log::info('Creating address with data:', $data); // DEBUG
    ...
    {
        try {
            Log::info('Update address request:', ['id' => $id, 'data' => $request->all()]); // DEBUG
            ...
            // PERBAIKAN: Cari address dengan cara yang lebih spesifik
            ...
            // PERBAIKAN: Pastikan is_default ada
            if (isset($data['is_default'])) {
                $data['is_default'] = (bool)$data['is_default'];
            }

            Log::info('Updating address with data:', $data); // DEBUG
    ...
    public function setDefault(Request $request, $id): JsonResponse
    {
        try {
            ...
            // PERBAIKAN: Cek dulu apakah address exists
            $address = UserAddress::where('user_id', $userId)->where('id', $id)->first();
